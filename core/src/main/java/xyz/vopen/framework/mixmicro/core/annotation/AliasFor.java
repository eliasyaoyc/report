 ...
 * {@link AliasFor}
 *
 * <p>Allows specifying an annotation member alias. In other words, a value of an annotation member
 * can be used to represent the value of another annotation's member or a another member within the
 * same annotation.
 *
 * <p>
 *
 * <p>The representation is constructed via the {@link AnnotationMetadata} interface
 *
