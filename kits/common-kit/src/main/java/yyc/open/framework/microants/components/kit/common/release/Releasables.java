...
import yyc.open.framework.microants.components.kit.common.io.IOKit;
...
/**
 * {@link Releasables} Utility methods to work with {@link Releasable}s.
 *
...
public enum Releasables {
     ...
     */
    public static void close(@NonNull Releasable releasable) {
        try {
            IOKit.close(releasable);
        } catch (IOException e) {
            throw new UncheckedIOException(e);
        }
    }
