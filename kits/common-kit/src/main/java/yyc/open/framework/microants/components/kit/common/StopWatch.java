package yyc.open.framework.microants.components.kit.common;

import yyc.open.framework.microants.components.kit.common.release.Releasable;
import yyc.open.framework.microants.components.kit.common.time.TimeValue;
...
/**
 * {@link StopWatch} Simple stop watch, allowing for timing of a number of tasks,
 * exposing total running time and running time for each named task.
 * <p>
 * Conceals use of <code>System.nanoTime()</code>, improving the readability of
 * application code and reducing the likelihood of calculation errors.
 * <p>
 * Note that this object is not designed to thread-safe and dose not
 * use synchronization.
 * <p>
...
public class StopWatch {
     ...
     * and need to distinguish between then in log or console output.
     */
